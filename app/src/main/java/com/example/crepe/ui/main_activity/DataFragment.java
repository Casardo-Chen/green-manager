...
public class DataFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("View My Trips");
    ...
    public void initCollectorInfoLayout() throws PackageManager.NameNotFoundException {
        ...
        CollectorInfoLayoutBuilder collectorInfoLayoutBuilder = new CollectorInfoLayoutBuilder(getContext(),dbManager);
        ...
        for(Ride ride : rideList) {
            ...
            LinearLayout collectorDetailView = collectorInfoLayoutBuilder.build(ride);
